...
sim_name <- paste0("sims", substr(num_sim, 1, nchar(num_sim)-3), "k_pop18")

# create data.frame with all parameter values ---------------
# sample size
sample_size <- rep(18, num_sim) # equal to smallest pop size, 181 for genetic clusters, 18 for populations (locality)
# number of loci
